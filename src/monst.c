...
NEARDATA struct permonst mons[] = {
     ...
     * ants
     */
    MON("giant ant", "¾ÞÐÍÂìÒÏ", S_ANT, LVL(2, 18, 3, 0, 0), (G_GENO | G_SGROUP | 3),
        ...
        4, CLR_BROWN),
    MON("killer bee", "É±ÈË·ä", S_ANT, LVL(1, 18, -1, 0, 0), (G_GENO | G_LGROUP | 2),
        ...
        5, CLR_YELLOW),
    MON("soldier ant", "±øÒÏ", S_ANT, LVL(3, 18, 3, 0, 0), (G_GENO | G_SGROUP | 2),
    ...
    MON("fire ant", "»ðÒÏ", S_ANT, LVL(3, 18, 3, 10, 0), (G_GENO | G_SGROUP | 1),
    ...
    MON("giant beetle", "¾ÞÐÍ¼×³æ", S_ANT, LVL(5, 6, 4, 0, 0), (G_GENO | 3),
        ...
        6, CLR_BLACK),
    MON("queen bee", "·äÍõ", S_ANT, LVL(9, 24, -4, 0, 0), (G_GENO | G_NOGEN),
     ...
     * blobs
     */
    MON("acid blob", "ËáµÎ", S_BLOB, LVL(1, 3, 8, 0, 0), (G_GENO | 2),
    ...
    MON("quivering blob", "²ü¶¶µÄ°ßµã", S_BLOB, LVL(5, 1, 8, 0, 0), (G_GENO | 2),
    ...
    MON("gelatinous cube", "ð¤½ºÁ¢·½¹Ö", S_BLOB, LVL(6, 6, 8, 0, 0), (G_GENO | 2),
     ...
     * cockatrice
     */
    MON("chickatrice", "Ð¡¼¦Éß", S_COCKATRICE, LVL(4, 4, 8, 30, 0),
        (G_GENO | G_SGROUP | 1),
    ...
    MON("cockatrice", "¼¦Éß", S_COCKATRICE, LVL(5, 6, 6, 30, 0), (G_GENO | 5),
    ...
    MON("pyrolisk", "»ð¼¦Éß", S_COCKATRICE, LVL(6, 6, 6, 30, 0), (G_GENO | 1),
     ...
     * dogs & other canines
     */
    MON("jackal", "²òÀÇ", S_DOG, LVL(0, 12, 7, 0, 0), (G_GENO | G_SGROUP | 3),
        ...
        1, CLR_BROWN),
    MON("fox", "ºüÀê", S_DOG, LVL(0, 15, 7, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(300, 250, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        1, CLR_RED),
    MON("coyote", "ÍÁÀÇ", S_DOG, LVL(1, 12, 7, 0, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(300, 250, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        2, CLR_BROWN),
    MON("werejackal", "²òÀÇÈË", S_DOG, LVL(2, 12, 7, 10, -7), (G_NOGEN | G_NOCORPSE),
    ...
    MON("little dog", "Ð¡¹·", S_DOG, LVL(2, 18, 6, 0, 0), (G_GENO | 1),
        ...
        3, HI_DOMESTIC),
    MON("dingo", "°ÄÖÞÒ°¹·", S_DOG, LVL(4, 16, 5, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("dog", "¹·", S_DOG, LVL(4, 16, 5, 0, 0), (G_GENO | 1),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_DOMESTIC, M3_INFRAVISIBLE,
        5, HI_DOMESTIC),
    MON("large dog", "´ó¹·", S_DOG, LVL(6, 15, 4, 0, 0), (G_GENO | 1),
    ...
    MON("wolf", "ÀÇ", S_DOG, LVL(5, 12, 4, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 250, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        6, CLR_BROWN),
    MON("werewolf", "ÀÇÈË", S_DOG, LVL(5, 12, 4, 20, -7), (G_NOGEN | G_NOCORPSE),
    ...
    MON("winter wolf cub", "¶¬ÀÇáÌ", S_DOG, LVL(5, 12, 4, 0, -5),
    ...
    MON("warg", "×ùÀÇ", S_DOG, LVL(7, 12, 4, 0, -5), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(850, 350, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        8, CLR_BROWN),
    MON("winter wolf", "¶¬ÀÇ", S_DOG, LVL(7, 12, 4, 20, 0), (G_NOHELL | G_GENO | 1),
        ...
        9, CLR_CYAN),
    MON("hell hound pup", "µØÓüÐ¡ÁÔÈ®", S_DOG, LVL(7, 12, 4, 20, -5),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        9, CLR_RED),
    MON("hell hound", "µØÓüÁÔÈ®", S_DOG, LVL(12, 14, 2, 20, 0), (G_HELL | G_GENO | 1),
...
#ifdef CHARON
    MON("Cerberus", "¿Ì¶ú°ØÂåË¹", S_DOG, LVL(12, 10, 2, 20, -7),
     ...
     * eyes
     */
    MON("gas spore", "ÆøÌåæß×Ó", S_EYE, LVL(1, 3, 10, 0, 0), (G_NOCORPSE | G_GENO | 1),
    ...
    MON("floating eye", "¸¡ÑÛ", S_EYE, LVL(2, 1, 9, 10, 0), (G_GENO | 5),
    ...
    MON("freezing sphere", "¶³½áÇò", S_EYE, LVL(6, 13, 4, 0, 0),
    ...
    MON("flaming sphere", "»ðÑæÇò", S_EYE, LVL(6, 13, 4, 0, 0),
    ...
    MON("shocking sphere", "µçÇò", S_EYE, LVL(6, 13, 4, 0, 0),
    ...
    MON("jaguar", "ÃÀÖÞ±ª", S_FELINE, LVL(4, 15, 6, 0, 0), (G_GENO | 2),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        6, CLR_BROWN),
    MON("lynx", "â¦áû", S_FELINE, LVL(5, 15, 6, 0, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
          ATTK(AT_BITE, AD_PHYS, 1, 10), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_GROWL, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        7, CLR_CYAN),
    MON("panther", "ºÚ±ª", S_FELINE, LVL(5, 15, 6, 0, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
          ATTK(AT_BITE, AD_PHYS, 1, 10), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_GROWL, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        7, CLR_BLACK),
    MON("large cat", "´óÃ¨", S_FELINE, LVL(6, 15, 4, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(250, 250, MS_MEW, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_STRONG | M2_DOMESTIC,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("tiger", "ÀÏ»¢", S_FELINE, LVL(6, 12, 6, 0, 0), (G_GENO | 2),
     ...
     */
    MON("gremlin", "Ð¡¹í", S_GREMLIN, LVL(5, 12, 2, 25, -9), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
        ...
        8, CLR_GREEN),
    MON("gargoyle", "Ê¯Ïñ¹í", S_GREMLIN, LVL(6, 10, -4, 0, -9), (G_GENO | 2),
        ...
        0, 8, CLR_BROWN),
    MON("winged gargoyle", "·ÉÒíÊ¯Ïñ¹í", S_GREMLIN, LVL(9, 15, -2, 0, -12), (G_GENO | 1),
     ...
     * humanoids
     */
    MON("hobbit", "»ô±ÈÌØÈË", S_HUMANOID, LVL(1, 9, 10, 0, 6), (G_GENO | 2),
    ...
    MON("dwarf", "°«ÈË", S_HUMANOID, LVL(2, 6, 10, 10, 4), (G_GENO | 3),
    ...
    MON("bugbear", "ÐÜµØ¾«", S_HUMANOID, LVL(3, 9, 5, 0, -6), (G_GENO | 1),
    ...
    MON("dwarf lord", "°«ÈËÁìÖ÷", S_HUMANOID, LVL(4, 6, 10, 10, 5), (G_GENO | 2),
    ...
    MON("dwarf king", "°«ÈËÍõ", S_HUMANOID, LVL(6, 6, 10, 20, 6), (G_GENO | 1),
    ...
    MON("mind flayer", "¶áÐÄÄ§", S_HUMANOID, LVL(9, 12, 5, 90, -8), (G_GENO | 1),
    ...
    MON("master mind flayer", "¶áÐÄÄ§´óÊ¦", S_HUMANOID, LVL(13, 12, 0, 90, -8),
        (G_GENO | 1),
     ...
     */
    MON("manes", "Áé»ê", S_IMP, LVL(1, 3, 7, 0, -7),
    ...
    MON("homunculus", "³ûÐÎÈË", S_IMP, LVL(2, 12, 6, 10, -7), (G_GENO | 2),
    ...
    MON("quasit", "¿äÈûÄ§", S_IMP, LVL(3, 15, 2, 20, -7), (G_GENO | 2),
    ...
    MON("tengu", "Ìì¹·", S_IMP, LVL(6, 13, 5, 30, 7), (G_GENO | 3),
     ...
     * jellies
     */
    MON("blue jelly", "À¶É«¹û¶³", S_JELLY, LVL(4, 0, 8, 10, 0), (G_GENO | 2),
    ...
    MON("spotted jelly", "ÕäÖé¹û¶³", S_JELLY, LVL(5, 0, 8, 10, 0), (G_GENO | 1),
    ...
    MON("ochre jelly", "ô÷¶³¹Ö", S_JELLY, LVL(6, 3, 8, 20, 0), (G_GENO | 2),
     ...
     * kobolds
     */
    MON("kobold", "¹·Í·ÈË", S_KOBOLD, LVL(0, 6, 10, 0, -2), (G_GENO | 1),
    ...
    MON("large kobold", "´ó¹·Í·ÈË", S_KOBOLD, LVL(1, 6, 10, 0, -3), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(450, 150, MS_ORC, MZ_SMALL), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_OMNIVORE, M2_HOSTILE | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 2, CLR_RED),
    MON("kobold lord", "¹·Í·ÈËÁìÖ÷", S_KOBOLD, LVL(2, 6, 10, 0, -4), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("kobold shaman", "¹·Í·ÈËÈøÂú", S_KOBOLD, LVL(2, 6, 6, 10, -4), (G_GENO | 1),
     ...
     * leprechauns
     */
    MON("leprechaun", "Ð¡°«Ñý", S_LEPRECHAUN, LVL(5, 15, 8, 20, 0), (G_GENO | 4),
     ...
     * mimics
     */
    MON("small mimic", "Ð¡ÄâÐÎ¹Ö", S_MIMIC, LVL(7, 3, 7, 0, 0), (G_GENO | 2),
    ...
    MON("large mimic", "´óÄâÐÎ¹Ö", S_MIMIC, LVL(8, 3, 7, 10, 0), (G_GENO | 1),
    ...
    MON("giant mimic", "¾ÞÐÍÄâÐÎ¹Ö", S_MIMIC, LVL(9, 3, 7, 20, 0), (G_GENO | 1),
     ...
     * nymphs
     */
    MON("wood nymph", "Ä¾ÏÉÅ®", S_NYMPH, LVL(3, 12, 9, 20, 0), (G_GENO | 2),
     ...
     */
    MON("orc", "ÊÞÈË", S_ORC, LVL(1, 9, 10, 0, -3), (G_GENO | G_NOGEN | G_LGROUP),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("orc-captain", "ÊÞÈË¶Ó³¤", S_ORC, LVL(5, 5, 10, 0, -5), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
     ...
     * piercers
     */
    MON("rock piercer", "ÑÒÊ¯×¶×Ó", S_PIERCER, LVL(3, 1, 3, 0, 0), (G_GENO | 4),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("iron piercer", "Ìú×¶×Ó", S_PIERCER, LVL(5, 1, 0, 0, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 3, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("glass piercer", "²£Á§×¶×Ó", S_PIERCER, LVL(7, 1, 0, 0, 0), (G_GENO | 1),
     ...
     * quadrupeds
     */
    MON("rothe", "ÂåË¹ÊÞ", S_QUADRUPED, LVL(2, 9, 7, 0, 0), (G_GENO | G_SGROUP | 4),
        ...
        4, CLR_BROWN),
    MON("mumak", "ÃÍáï", S_QUADRUPED, LVL(5, 9, 0, 0, -2), (G_GENO | 1),
    ...
    MON("leocrotta", "ÀÇ¹·", S_QUADRUPED, LVL(6, 18, 4, 10, 0), (G_GENO | 2),
        ...
        M3_INFRAVISIBLE, 8, CLR_RED),
    MON("wumpus", "Ê¨Í·Ïó", S_QUADRUPED, LVL(8, 3, 2, 10, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 3, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("titanothere", "À×ÊÞ", S_QUADRUPED, LVL(12, 12, 6, 0, 0), (G_GENO | 2),
    ...
    MON("baluchitherium", "ÙÂÂ·Ö§ÊÞ", S_QUADRUPED, LVL(14, 12, 5, 0, 0), (G_GENO | 2),
    ...
    MON("mastodon", "Èé³ÝÏó", S_QUADRUPED, LVL(20, 12, 5, 0, 0), (G_GENO | 1),
     ...
     * rodents
     */
    MON("sewer rat", "ºÖÊó", S_RODENT, LVL(0, 12, 7, 0, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(20, 12, MS_SQEEK, MZ_TINY), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        1, CLR_BROWN),
    MON("giant rat", "¾ÞÊó", S_RODENT, LVL(1, 10, 7, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(30, 30, MS_SQEEK, MZ_TINY), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        2, CLR_BROWN),
    MON("rabid rat", "¿ñÊó", S_RODENT, LVL(2, 12, 6, 0, 0), (G_GENO | 1),
    ...
    MON("wererat", "ÊóÈË", S_RODENT, LVL(2, 12, 6, 10, -7), (G_NOGEN | G_NOCORPSE),
        A(ATTK(AT_BITE, AD_WERE, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(40, 30, MS_SQEEK, MZ_TINY), MR_POISON, 0,
        M1_NOHANDS | M1_POIS | M1_REGEN | M1_CARNIVORE,
        M2_NOPOLY | M2_WERE | M2_HOSTILE, M3_INFRAVISIBLE, 4, CLR_BROWN),
    MON("rock mole", "ÑÒÊ¯÷úÊó", S_RODENT, LVL(3, 3, 0, 20, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        4, CLR_GRAY),
    MON("woodchuck", "ÍÁ²¦Êó", S_RODENT, LVL(3, 3, 0, 20, 0), (G_NOGEN | G_GENO),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(30, 30, MS_SILENT, MZ_SMALL), 0, 0,
     ...
     */
    MON("cave spider", "¶´Ñ¨Ö©Öë", S_SPIDER, LVL(1, 12, 3, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 2), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("centipede", "òÚò¼", S_SPIDER, LVL(2, 4, 3, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_DRST, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(50, 50, MS_SILENT, MZ_TINY), MR_POISON, MR_POISON,
        M1_CONCEAL | M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_CARNIVORE,
        M2_HOSTILE, 0, 4, CLR_YELLOW),
    MON("giant spider", "¾ÞÐÍÖ©Öë", S_SPIDER, LVL(5, 15, 4, 0, 0), (G_GENO | 1),
    ...
    MON("scorpion", "Ð«×Ó", S_SPIDER, LVL(5, 15, 3, 0, 0), (G_GENO | 2),
     ...
     * trappers, lurkers, &c
     */
    MON("lurker above", "Ç±·üÕß", S_TRAPPER, LVL(10, 3, 3, 0, 0), (G_GENO | 2),
    ...
    MON("trapper", "²¶ÊÞÕß", S_TRAPPER, LVL(12, 3, 3, 0, 0), (G_GENO | 2),
     ...
     * unicorns and horses
     */
    MON("pony", "Ð¡Âí", S_UNICORN, LVL(3, 16, 6, 0, 0), (G_GENO | 2),
    ...
    MON("white unicorn", "°×É«¶À½ÇÊÞ", S_UNICORN, LVL(4, 24, 2, 70, 7), (G_GENO | 2),
    ...
    MON("gray unicorn", "»ÒÉ«¶À½ÇÊÞ", S_UNICORN, LVL(4, 24, 2, 70, 0), (G_GENO | 1),
        A(ATTK(AT_BUTT, AD_PHYS, 1, 12), ATTK(AT_KICK, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1300, 300, MS_NEIGH, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOHANDS | M1_HERBIVORE, M2_WANDER | M2_STRONG | M2_JEWELS,
        M3_INFRAVISIBLE, 6, CLR_GRAY),
    MON("black unicorn", "ºÚÉ«¶À½ÇÊÞ", S_UNICORN, LVL(4, 24, 2, 70, -7), (G_GENO | 1),
        A(ATTK(AT_BUTT, AD_PHYS, 1, 12), ATTK(AT_KICK, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1300, 300, MS_NEIGH, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOHANDS | M1_HERBIVORE, M2_WANDER | M2_STRONG | M2_JEWELS,
        M3_INFRAVISIBLE, 6, CLR_BLACK),
    MON("horse", "Âí", S_UNICORN, LVL(5, 20, 5, 0, 0), (G_GENO | 2),
    ...
    MON("warhorse", "Õ½Âí", S_UNICORN, LVL(7, 24, 4, 0, 0), (G_GENO | 2),
     ...
     * vortices
     */
    MON("fog cloud", "ÎíÔÆ", S_VORTEX, LVL(3, 1, 0, 0, 0), (G_GENO | G_NOCORPSE | 2),
    ...
    MON("dust vortex", "³¾°£ÐýÎÐ", S_VORTEX, LVL(4, 20, 2, 30, 0),
    ...
    MON("ice vortex", "±ùÐýÎÐ", S_VORTEX, LVL(5, 20, 2, 30, 0),
    ...
    MON("energy vortex", "ÄÜÁ¿ÐýÎÐ", S_VORTEX, LVL(6, 20, 2, 30, 0),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("steam vortex", "ÕôÆûÐýÎÐ", S_VORTEX, LVL(7, 22, 2, 30, 0),
    ...
    MON("fire vortex", "»ðÐýÎÐ", S_VORTEX, LVL(8, 22, 2, 30, 0),
    ...
    MON("purple worm", "×ÏÈä³æ", S_WORM, LVL(15, 9, 6, 20, 0), (G_GENO | 2),
     ...
     * xan, &c
     */
    MON("grid bug", "µç×Ó³æ", S_XAN, LVL(0, 12, 9, 0, 0),
    ...
    MON("xan", "ÐþÎÃ", S_XAN, LVL(7, 18, -4, 0, 0), (G_GENO | 3),
     ...
     * lights
     */
    MON("yellow light", "»Æ¹â", S_LIGHT, LVL(3, 15, 0, 0, 0),
    ...
    MON("black light", "ºÚ¹â", S_LIGHT, LVL(5, 15, 0, 0, 0),
     ...
     * zruty
     */
    MON("zruty", "É½Çø¾ÞÈË", S_ZRUTY, LVL(9, 8, 3, 0, 0), (G_GENO | 2),
     ...
     */
    MON("couatl", "ÓðÉß", S_ANGEL, LVL(8, 10, 5, 30, 7),
    ...
    MON("Aleax", "ÑÇÀú¿ËË¹", S_ANGEL, LVL(10, 8, 0, 30, 7), (G_NOHELL | G_NOCORPSE | 1),
    ...
    MON("Angel", "ÌìÊ¹", S_ANGEL, LVL(14, 10, -4, 55, 12),
    ...
    MON("ki-rin", "÷è÷ë", S_ANGEL, LVL(16, 18, -5, 90, 15),
        (G_NOHELL | G_NOCORPSE | 1),
    ...
    MON("Archon", "Ö´Õþ¹Ù", S_ANGEL, LVL(19, 16, -6, 80, 15),
        (G_NOHELL | G_NOCORPSE | 1),
    ...
    MON("vampire bat", "ÎüÑªòùòð", S_BAT, LVL(5, 20, 6, 0, 0), (G_GENO | 2),
     ...
     * Centaurs
     */
    MON("plains centaur", "Æ½Ô­°ëÈËÂí", S_CENTAUR, LVL(4, 18, 4, 0, 0), (G_GENO | 1),
    ...
    MON("forest centaur", "É­ÁÖ°ëÈËÂí", S_CENTAUR, LVL(5, 18, 3, 10, -1), (G_GENO | 1),
    ...
    MON("mountain centaur", "É½°ëÈËÂí", S_CENTAUR, LVL(6, 20, 2, 10, -3), (G_GENO | 1),
     ...
     */
    MON("baby gray dragon", "Ó×»ÒÁú", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("baby silver dragon", "Ó×ÒøÁú", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), 0, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
...
#endif
    MON("baby red dragon", "Ó×ºìÁú", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("baby yellow dragon", "Ó×»ÆÁú", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("gray dragon", "»ÒÁú", S_DRAGON, LVL(15, 9, -1, 20, 4), (G_GENO | 1),
        ...
        0, 20, CLR_GRAY),
    MON("silver dragon", "ÒøÁú", S_DRAGON, LVL(15, 9, -1, 20, 4), (G_GENO | 1),
    ...
    MON("shimmering dragon", S_DRAGON,
        ...
        0, 20, CLR_CYAN),
#endif
    MON("red dragon", "ºìÁú", S_DRAGON, LVL(15, 9, -1, 20, -4), (G_GENO | 1),
    ...
    MON("white dragon", "°×Áú", S_DRAGON, LVL(15, 9, -1, 20, -5), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_COLD, 4, 6), ATTK(AT_BITE, AD_PHYS, 3, 8),
          ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4), NO_ATTK,
          NO_ATTK),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, CLR_WHITE),
    MON("orange dragon", "³ÈÁú", S_DRAGON, LVL(15, 9, -1, 20, 5), (G_GENO | 1),
    ...
    MON("black dragon", "ºÚÁú", S_DRAGON, LVL(15, 9, -1, 20, -6), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, CLR_BLACK),
    MON("blue dragon", "À¶Áú", S_DRAGON, LVL(15, 9, -1, 20, -7), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, CLR_BLUE),
    MON("green dragon", "ÂÌÁú", S_DRAGON, LVL(15, 9, -1, 20, 6), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, CLR_GREEN),
    MON("yellow dragon", "»ÆÁú", S_DRAGON, LVL(15, 9, -1, 20, 7), (G_GENO | 1),
     ...
     * Elementals
     */
    MON("stalker", "Ç±ÐÐÕß", S_ELEMENTAL, LVL(8, 12, 3, 0, 0), (G_GENO | 3),
        ...
        9, CLR_WHITE),
    MON("air elemental", "¿ÕÆøÔªËØ", S_ELEMENTAL, LVL(8, 36, 2, 30, 0), (G_NOCORPSE | 1),
    ...
    MON("fire elemental", "»ðÔªËØ", S_ELEMENTAL, LVL(8, 12, 2, 30, 0), (G_NOCORPSE | 1),
    ...
    MON("earth elemental", "ÍÁÔªËØ", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | 1),
    ...
    MON("water elemental", "Ë®ÔªËØ", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | 1),
     ...
     * Fungi
     */
    MON("lichen", "µØÒÂ", S_FUNGUS, LVL(0, 1, 9, 0, 0), (G_GENO | 4),
    ...
    MON("brown mold", "×ØÃ¹¾ú", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 1),
        A(ATTK(AT_NONE, AD_COLD, 0, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("yellow mold", "»ÆÃ¹¾ú", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 2),
    ...
    MON("green mold", "ÂÌÃ¹¾ú", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 1),
    ...
    MON("red mold", "ºìÃ¹¾ú", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 1),
    ...
    MON("shrieker", "¼â½ÐÞ¦", S_FUNGUS, LVL(3, 1, 7, 0, 0), (G_GENO | 1),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(100, 100, MS_SHRIEK, MZ_SMALL), MR_POISON, MR_POISON,
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, 2, CLR_MAGENTA),
    MON("violet fungus", "×ÏÕæ¾ú", S_FUNGUS, LVL(3, 1, 7, 0, 0), (G_GENO | 2),
    ...
    MON("gnomish wizard", "ÙªÈåÎ×Ê¦", S_GNOME, LVL(3, 10, 4, 10, 0), (G_GENO | 1),
        A(ATTK(AT_MAGC, AD_SPEL, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(700, 120, MS_ORC, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
        M2_GNOME | M2_MAGIC, M3_INFRAVISIBLE | M3_INFRAVISION, 5, HI_ZAP),
    MON("gnome king", "ÙªÈåÍõ", S_GNOME, LVL(5, 10, 10, 20, 0), (G_GENO | 1),
...
struct permonst _mons2[] = {
     ...
     * giant Humanoids
     */
    MON("giant", "¾ÞÈË", S_GIANT, LVL(6, 6, 0, 0, 2), (G_GENO | G_NOGEN | 1),
    ...
    MON("stone giant", "Ê¯Í·¾ÞÈË", S_GIANT, LVL(6, 6, 0, 0, 2), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(2250, 750, MS_BOAST, MZ_HUGE), 0, 0, M1_HUMANOID | M1_CARNIVORE,
        M2_GIANT | M2_STRONG | M2_ROCKTHROW | M2_NASTY | M2_COLLECT
    ...
    MON("hill giant", "ÇðÁê¾ÞÈË", S_GIANT, LVL(8, 10, 6, 0, -2), (G_GENO | G_SGROUP | 1),
    ...
    MON("fire giant", "»ð¾ÞÈË", S_GIANT, LVL(9, 12, 4, 5, 2), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("frost giant", "Ëª¾ÞÈË", S_GIANT, LVL(10, 12, 3, 10, -3),
    ...
    MON("ettin", "Ë«Í·¾ÞÈË", S_GIANT, LVL(10, 12, 3, 0, 0), (G_GENO | 1),
    ...
    MON("storm giant", "·ç±©¾ÞÈË", S_GIANT, LVL(16, 12, 3, 10, -3),
    ...
    MON("titan", "ÌáÌ¹", S_GIANT, LVL(16, 18, -3, 70, 9), (1),
    ...
    MON("minotaur", "ÃÖÅµÌÕÂåË¹", S_GIANT, LVL(15, 15, 6, 0, 0), (G_GENO | G_NOGEN),
    ...
    MON("jabberwock", "¼Õ²±Áú", S_JABBERWOCK, LVL(15, 12, -2, 50, 0), (G_GENO | 1),
     ...
     * Kops
     */
    MON("Keystone Kop", "¼ªË¹Í¨¾¯²ì", S_KOP, LVL(1, 6, 10, 10, 9),
    ...
    MON("Kop Sergeant", "¼ªË¹Í¨¾¯Ë¾", S_KOP, LVL(2, 8, 10, 10, 10),
    ...
    MON("Kop Lieutenant", "¼ªË¹Í¨¾¯¶½", S_KOP, LVL(3, 10, 10, 20, 11), (G_GENO | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
        M2_HUMAN | M2_WANDER | M2_HOSTILE | M2_STRONG | M2_MALE | M2_COLLECT,
        M3_INFRAVISIBLE, 5, CLR_CYAN),
    MON("Kop Kaptain", "¼ªË¹Í¨¾¯¼à", S_KOP, LVL(4, 12, 10, 20, 12), (G_GENO | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
        M2_HUMAN | M2_WANDER | M2_HOSTILE | M2_STRONG | M2_MALE | M2_COLLECT,
     ...
     * Liches
     */
    MON("lich", "Î×Ñý", S_LICH, LVL(11, 6, 0, 30, -9), (G_GENO | G_NOCORPSE | 1),
    ...
    MON("demilich", "°ëÎ×Ñý", S_LICH, LVL(14, 9, -2, 60, -12),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("master lich", "Î×Ñý´óÊ¦", S_LICH, LVL(17, 9, -4, 90, -15),
        (G_HELL | G_GENO | G_NOCORPSE | 1),
        ...
        21, HI_LORD),
    MON("arch-lich", "´óÎ×Ñý", S_LICH, LVL(25, 9, -6, 90, -15),
        (G_HELL | G_GENO | G_NOCORPSE | 1),
     ...
     * Mummies
     */
    MON("kobold mummy", "¹·Í·ÈËÄ¾ÄËÒÁ", S_MUMMY, LVL(3, 8, 6, 20, -2),
    ...
    MON("gnome mummy", "ÙªÈåÄ¾ÄËÒÁ", S_MUMMY, LVL(4, 10, 6, 20, -3),
    ...
    MON("orc mummy", "ÊÞÈËÄ¾ÄËÒÁ", S_MUMMY, LVL(5, 10, 5, 20, -4),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 6), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("dwarf mummy", "°«ÈËÄ¾ÄËÒÁ", S_MUMMY, LVL(5, 10, 5, 20, -4),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 6), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("elf mummy", "¾«ÁéÄ¾ÄËÒÁ", S_MUMMY, LVL(6, 12, 4, 30, -5),
    ...
    MON("human mummy", "ÈËÀàÄ¾ÄËÒÁ", S_MUMMY, LVL(6, 12, 4, 30, -5),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("ettin mummy", "Ë«Í·Ä¾ÄËÒÁ", S_MUMMY, LVL(7, 12, 4, 30, -6),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("giant mummy", "¾ÞÈËÄ¾ÄËÒÁ", S_MUMMY, LVL(8, 14, 3, 30, -7),
        (G_GENO | G_NOCORPSE | 1),
     ...
     * Nagas
     */
    MON("red naga hatchling", "ºìÓ×ÄÉåÈ", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("black naga hatchling", "ºÚÓ×ÄÉåÈ", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("golden naga hatchling", "½ðÓ×ÄÉåÈ", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 100, MS_MUMBLE, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOLIMBS | M1_SLITHY | M1_THICK_HIDE | M1_NOTAKE | M1_OMNIVORE,
        M2_STRONG, 0, 4, HI_GOLD),
    MON("guardian naga hatchling", "Ó×ÄÉåÈÊØÎÀ", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 100, MS_MUMBLE, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOLIMBS | M1_SLITHY | M1_THICK_HIDE | M1_NOTAKE | M1_OMNIVORE,
        M2_STRONG, 0, 4, CLR_GREEN),
    MON("red naga", "ºìÄÉåÈ", S_NAGA, LVL(6, 12, 4, 0, -4), (G_GENO | 1),
    ...
    MON("black naga", "ºÚÄÉåÈ", S_NAGA, LVL(8, 14, 2, 10, 4), (G_GENO | 1),
    ...
    MON("golden naga", "½ðÄÉåÈ", S_NAGA, LVL(10, 14, 2, 70, 5), (G_GENO | 1),
    ...
    MON("guardian naga", "ÄÉåÈÊØÎÀ", S_NAGA, LVL(12, 16, 0, 50, 7), (G_GENO | 1),
     ...
     * Ogres
     */
    MON("ogre", "Ê³ÈËÄ§", S_OGRE, LVL(5, 10, 5, 0, -3), (G_SGROUP | G_GENO | 1),
    ...
    MON("ogre lord", "Ê³ÈËÄ§ÁìÖ÷", S_OGRE, LVL(7, 12, 3, 30, -5), (G_GENO | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("ogre king", "Ê³ÈËÄ§Íõ", S_OGRE, LVL(9, 14, 4, 60, -7), (G_GENO | 2),
     ...
     */
    MON("gray ooze", "»ÒÉ«ÈíÄà", S_PUDDING, LVL(3, 1, 8, 0, 0), (G_GENO | G_NOCORPSE | 2),
        ...
        M2_HOSTILE | M2_NEUTER, 0, 4, CLR_GRAY),
    MON("brown pudding", "×ØÉ«²¼¶¡", S_PUDDING, LVL(5, 3, 8, 0, 0),
        ...
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_OMNIVORE | M1_ACID,
        M2_HOSTILE | M2_NEUTER, 0, 6, CLR_BROWN),
    MON("green slime", "ÂÌÉ«ð¤Òº", S_PUDDING, LVL(6, 6, 6, 0, 0),
        (G_HELL | G_GENO | G_NOCORPSE | 1),
    ...
    MON("black pudding", "ºÚÉ«²¼¶¡", S_PUDDING, LVL(10, 6, 6, 0, 0),
        (G_GENO | G_NOCORPSE | 1),
     ...
     * Quantum mechanics
     */
    MON("quantum mechanic", "Á¿×ÓÁ¦Ñ§", S_QUANTMECH, LVL(7, 12, 3, 10, 0), (G_GENO | 3),
     ...
     */
    MON("rust monster", "Ðâ¹Ö", S_RUSTMONST, LVL(5, 18, 2, 0, 0), (G_GENO | 2),
    ...
    MON("disenchanter", "½âÄ§¹Ö", S_RUSTMONST, LVL(12, 12, -10, 0, -3),
        (G_HELL | G_GENO | 2),
     ...
     * Snakes
     */
    MON("garter snake", "Êø´øÉß", S_SNAKE, LVL(1, 8, 8, 0, 0), (G_LGROUP | G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 2), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        0, 0, 3, CLR_GREEN),
    MON("snake", "Éß", S_SNAKE, LVL(4, 15, 3, 0, 0), (G_GENO | 2),
        ...
        M1_SWIM | M1_CONCEAL | M1_NOLIMBS | M1_ANIMAL | M1_SLITHY | M1_POIS
            | M1_OVIPAROUS | M1_CARNIVORE | M1_NOTAKE,
        M2_HOSTILE, 0, 6, CLR_BROWN),
    MON("water moccasin", "Ë®òóÉß", S_SNAKE, LVL(4, 15, 3, 0, 0),
    ...
    MON("python", "¾Þòþ", S_SNAKE, LVL(6, 3, 5, 0, 0), (G_GENO | 1),
    ...
    MON("pit viper", "ÏìÎ²Éß", S_SNAKE, LVL(6, 15, 2, 0, 0), (G_GENO | 1),
    ...
    MON("cobra", "ÑÛ¾µÉß", S_SNAKE, LVL(6, 18, 2, 0, 0), (G_GENO | 1),
     ...
     * Trolls
     */
    MON("troll", "¾ÞÄ§", S_TROLL, LVL(7, 12, 4, 0, -3), (G_GENO | 2),
        ...
        9, CLR_BROWN),
    MON("ice troll", "±ù¾ÞÄ§", S_TROLL, LVL(9, 10, 2, 20, -3), (G_NOHELL | G_GENO | 1),
        ...
        M2_STRONG | M2_STALK | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION,
        12, CLR_WHITE),
    MON("rock troll", "ÑÒÊ¯¾ÞÄ§", S_TROLL, LVL(9, 12, 0, 0, -3), (G_GENO | 1),
    ...
    MON("water troll", "Ë®¾ÞÄ§", S_TROLL, LVL(11, 14, 4, 40, -3), (G_NOGEN | G_GENO),
        ...
        M2_STRONG | M2_STALK | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION,
        13, CLR_BLUE),
    MON("Olog-hai", "Å·ÂÞº£", S_TROLL, LVL(13, 12, -4, 0, -7), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 2, 8),
          ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
     ...
     * Umber hulk
     */
    MON("umber hulk", "ÍÁ¾Þ¹Ö", S_UMBER, LVL(9, 6, 2, 25, 0), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 4), ATTK(AT_CLAW, AD_PHYS, 3, 4),
     ...
     * Vampires
     */
    MON("vampire", "ÎüÑª¹í", S_VAMPIRE, LVL(10, 12, 1, 25, -8),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("vampire lord", "ÎüÑª¹íÁìÖ÷", S_VAMPIRE, LVL(12, 14, 0, 50, -9),
        (G_GENO | G_NOCORPSE | 1),
...
#endif
    MON("Vlad the Impaler", "´©´ÌÕß¸¥À­µÂ", S_VAMPIRE, LVL(28, 26, -6, 80, -10),
     ...
     * Wraiths
     */
    MON("barrow wight", "¹ÅÄ¹Ê¬Ñý", S_WRAITH, LVL(3, 12, 5, 5, -3),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("wraith", "ÓÄÁé", S_WRAITH, LVL(6, 12, 4, 15, -6), (G_GENO | 2),
    ...
    MON("Nazgul", "½äÁé", S_WRAITH, LVL(13, 12, 0, 25, -17),
        (G_GENO | G_NOCORPSE | 1),
     ...
     * Xorn
     */
    MON("xorn", "Ë÷¶ûÊ¯¹Ö", S_XORN, LVL(8, 9, -2, 20, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
    ...
    MON("monkey", "ºï×Ó", S_YETI, LVL(2, 12, 6, 0, 0), (G_GENO | 1),
    ...
    MON("ape", "Ô³", S_YETI, LVL(4, 12, 6, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
        ...
        6, CLR_BROWN),
    MON("owlbear", "èÉÐÜ", S_YETI, LVL(5, 12, 5, 0, 0), (G_GENO | 3),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
     ...
     * Zombies
     */
    MON("kobold zombie", "¹·Í·ÈË½©Ê¬", S_ZOMBIE, LVL(0, 6, 10, 0, -2),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 4), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_STALK | M2_HOSTILE, M3_INFRAVISION, 1, CLR_BROWN),
    MON("gnome zombie", "ÙªÈå½©Ê¬", S_ZOMBIE, LVL(1, 6, 10, 0, -2),
        ...
        2, CLR_BROWN),
    MON("orc zombie", "ÊÞÈË½©Ê¬", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
        ...
        CLR_GRAY),
    MON("dwarf zombie", "°«ÈË½©Ê¬", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(900, 150, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
        ...
        3, CLR_RED),
    MON("elf zombie", "¾«Áé½©Ê¬", S_ZOMBIE, LVL(3, 6, 9, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 1),
        ...
        4, CLR_GREEN),
    MON("human zombie", "ÈËÀà½©Ê¬", S_ZOMBIE, LVL(4, 6, 8, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 1),
    ...
    MON("ettin zombie", "Ë«Í·½©Ê¬", S_ZOMBIE, LVL(6, 8, 6, 0, -4),
        (G_GENO | G_NOCORPSE | 1),
        ...
        7, CLR_BLUE),
    MON("ghoul", "Ê³Ê¬¹í", S_ZOMBIE, LVL(3, 6, 10, 0, -2), (G_GENO | G_NOCORPSE | 1),
    ...
    MON("giant zombie", "¾ÞÈË½©Ê¬", S_ZOMBIE, LVL(8, 8, 6, 0, -4),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("skeleton", "÷¼÷Ã", S_ZOMBIE, LVL(12, 8, 4, 0, 0), (G_NOCORPSE | G_NOGEN),
     ...
     * golems
     */
    MON("straw golem", "µ¾²ÝÄ§Ïñ", S_GOLEM, LVL(3, 12, 10, 0, 0), (G_NOCORPSE | 1),
        ...
        4, CLR_YELLOW),
    MON("paper golem", "Ö½Ä§Ïñ", S_GOLEM, LVL(3, 12, 10, 0, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(400, 0, MS_SILENT, MZ_LARGE), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID, M2_HOSTILE | M2_NEUTER, 0,
        4, HI_PAPER),
    MON("rope golem", "Éþ×ÓÄ§Ïñ", S_GOLEM, LVL(4, 9, 8, 0, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
          ATTK(AT_HUGS, AD_PHYS, 6, 1), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(450, 0, MS_SILENT, MZ_LARGE), MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID, M2_HOSTILE | M2_NEUTER, 0,
        6, CLR_BROWN),
    MON("gold golem", "½ðÄ§Ïñ", S_GOLEM, LVL(5, 9, 6, 0, 0), (G_NOCORPSE | 1),
    ...
    MON("flesh golem", "ÈâÄ§Ïñ", S_GOLEM, LVL(9, 8, 9, 30, 0), (1),
        ...
        10, CLR_RED),
    MON("clay golem", "ÍÁÄ§Ïñ", S_GOLEM, LVL(11, 7, 7, 40, 0), (G_NOCORPSE | 1),
    ...
    MON("stone golem", "Ê¯Ä§Ïñ", S_GOLEM, LVL(14, 6, 5, 50, 0), (G_NOCORPSE | 1),
    ...
    MON("glass golem", "²£Á§Ä§Ïñ", S_GOLEM, LVL(16, 6, 1, 50, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_PHYS, 2, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1800, 0, MS_SILENT, MZ_LARGE), MR_SLEEP | MR_POISON | MR_ACID, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
        M2_HOSTILE | M2_STRONG, 0, 18, CLR_CYAN),
    MON("iron golem", "ÌúÄ§Ïñ", S_GOLEM, LVL(18, 6, 3, 60, 0), (G_NOCORPSE | 1),
     ...
     */
    MON("human", "ÈË", S_HUMAN, LVL(0, 12, 10, 0, 0), G_NOGEN, /* for corpses */
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        2, HI_DOMESTIC),
    MON("wererat", "ÊóÈË", S_HUMAN, LVL(2, 12, 10, 10, -7), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("werejackal", "²òÀÇÈË", S_HUMAN, LVL(2, 12, 10, 10, -7), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_WERE, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
    ...
    MON("werewolf", "ÀÇÈË", S_HUMAN, LVL(5, 12, 10, 20, -7), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_WERE, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
    ...
    MON("elf", "¾«Áé", S_HUMAN, LVL(10, 12, 10, 2, -3), G_NOGEN, /* for corpses */
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("Woodland-elf", "ÎéµÂÀ¼¾«Áé", S_HUMAN, LVL(4, 12, 10, 10, -5),
    ...
    MON("Green-elf", "ÂÌ¾«Áé", S_HUMAN, LVL(5, 12, 10, 10, -6), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS, M2_ELF | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 7, CLR_BRIGHT_GREEN),
    MON("Grey-elf", "»Ò¾«Áé", S_HUMAN, LVL(6, 12, 10, 10, -7), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS, M2_ELF | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 8, CLR_GRAY),
    MON("elf-lord", "¾«ÁéÁìÖ÷", S_HUMAN, LVL(8, 12, 10, 20, -9), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
    ...
    MON("Elvenking", "¾«ÁéÍõ", S_HUMAN, LVL(9, 12, 10, 25, -10), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 11, HI_LORD),
    MON("doppelganger", "±äÐÎÈË", S_HUMAN, LVL(9, 12, 5, 20, 0), (G_GENO | 1),
    ...
    MON("shopkeeper", "µêÖ÷", S_HUMAN, LVL(12, 18, 0, 50, 0), G_NOGEN,
    ...
    MON("guard", "¾¯ÎÀ", S_HUMAN, LVL(12, 12, 10, 40, 10), G_NOGEN,
        ...
        M3_INFRAVISIBLE, 14, CLR_BLUE),
    MON("prisoner", "Çô·¸", S_HUMAN, LVL(12, 12, 10, 0, 0),
    ...
    MON("Oracle", "ÉñÚÍ", S_HUMAN, LVL(12, 0, 0, 50, 0), (G_NOGEN | G_UNIQ),
    ...
    /* aligned priests always have the epri extension attached;
       ...
       or isminion set */
    MON("aligned priest", "ò¯³ÏµÄÄÁÊ¦", S_HUMAN, LVL(12, 12, 10, 50, 0), G_NOGEN,
    ...
    MON("high priest", "¸ß¼¶¼ÀË¾", S_HUMAN, LVL(25, 15, 7, 70, 0), (G_NOGEN | G_UNIQ),
    ...
    MON("soldier", "Ê¿±ø", S_HUMAN, LVL(6, 10, 10, 0, -2), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("sergeant", "ÖÐÊ¿", S_HUMAN, LVL(8, 10, 10, 5, -3), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
    ...
    MON("nurse", "»¤Ê¿", S_HUMAN, LVL(11, 6, 0, 0, 0), (G_GENO | 3),
    ...
    MON("lieutenant", "ÖÐÎ¾", S_HUMAN, LVL(10, 10, 10, 15, -4), (G_GENO | 1),
    ...
    MON("captain", "ÉÏÎ¾", S_HUMAN, LVL(12, 10, 10, 15, -5), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
     ...
     */
    MON("watchman", "¾¯ÎÀÔ±", S_HUMAN, LVL(6, 10, 10, 0, -2),
        ...
        M3_INFRAVISIBLE, 8, CLR_GRAY),
    MON("watch captain", "¾¯ÎÀÔ±¶Ó³¤", S_HUMAN, LVL(10, 10, 10, 15, -4),
        (G_NOGEN | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 4), ATTK(AT_WEAP, AD_PHYS, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
     ...
     */
    MON("Medusa", "ÃÀ¶ÅÉ¯", S_HUMAN, LVL(20, 12, 2, 50, -15), (G_NOGEN | G_UNIQ),
    ...
    MON("Wizard of Yendor", "ÑÒµÂÎ×Ê¦", S_HUMAN, LVL(30, 12, -8, 100, A_NONE),
        (G_NOGEN | G_UNIQ),
    ...
    MON("Croesus", "¿ËÂÞÒÁË¹", S_HUMAN, LVL(20, 15, 0, 40, 15), (G_UNIQ | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARD, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_SEE_INVIS | M1_OMNIVORE,
...
#ifdef CHARON
    MON("Charon", "¿¨Â¡", S_HUMAN, LVL(76, 18, -5, 120, 0),
     ...
     * ghosts
     */
    MON("ghost", "¹í»ê", S_GHOST, LVL(10, 3, -5, 50, -5), (G_NOCORPSE | G_NOGEN),
        ...
        12, CLR_GRAY),
    MON("shade", "»êÁé", S_GHOST, LVL(12, 10, 10, 0, 0), (G_NOCORPSE | G_NOGEN),
     ...
     * (major) demons
     */
    MON("water demon", "Ë®Ñý", S_DEMON, LVL(8, 12, -4, 30, -7),
        (G_NOCORPSE | G_NOGEN),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("succubus", "÷ÈÄ§", S_DEMON, LVL(6, 12, 0, 70, -9), (G_NOCORPSE | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 8, CLR_GRAY),
    MON("horned devil", "ÓÐ½ÇµÄÄ§¹í", S_DEMON, LVL(6, 9, -5, 50, 11),
        (G_HELL | G_NOCORPSE | 2),
    ...
    MON("incubus", "ÃÎ÷Ê", S_DEMON, LVL(6, 12, 0, 70, -9), (G_NOCORPSE | 1),
        SEDUCTION_ATTACKS_YES, SIZ(WT_HUMAN, 400, MS_SEDUCE, MZ_HUMAN),
        MR_FIRE | MR_POISON, 0, M1_HUMANOID | M1_FLY | M1_POIS,
    ...
    MON("erinys", "ÒÁÀïÄæË¿", S_DEMON, LVL(7, 12, 2, 30, 10),
    ...
    MON("barbed devil", "¹þÂêÄ§", S_DEMON, LVL(8, 12, 0, 35, 8),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
        ...
        M1_POIS | M1_THICK_HIDE, M2_DEMON | M2_STALK | M2_HOSTILE | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION, 10, CLR_RED),
    MON("marilith", "Áù±ÛÉßÄ§", S_DEMON, LVL(7, 12, -6, 80, -12),
        (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
    ...
    MON("vrock", "¸¥ÂåÄ§", S_DEMON, LVL(8, 12, 0, 50, -9),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 11, CLR_RED),
    MON("hezrou", "¿ñÕ½Ä§", S_DEMON, LVL(9, 6, -2, 55, -10),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
    ...
    MON("bone devil", "¹ÇÄ§", S_DEMON, LVL(9, 15, -1, 40, -9),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
    ...
    MON("ice devil", "±ùÄ§", S_DEMON, LVL(11, 6, -4, 55, -12),
        (G_HELL | G_NOCORPSE | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
    ...
    MON("nalfeshnee", "ÅÐ»êÄ§", S_DEMON, LVL(11, 9, -1, 65, -11),
        (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
    ...
    MON("pit fiend", "ÉîÔ¨¶ñÄ§", S_DEMON, LVL(13, 6, -3, 65, -13),
        (G_HELL | G_NOCORPSE | 2),
    ...
    MON("sandestin", "É£µÂË¹Í¢", S_DEMON, LVL(13, 12, 4, 60, -5),
        (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("balrog", "Ñ×Ä§", S_DEMON, LVL(16, 5, -2, 75, -14), (G_HELL | G_NOCORPSE | 1),
     ...
     */
    MON("Juiblex", "Öì±ÈÁÒË¹", S_DEMON, LVL(50, 3, -7, 65, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
    ...
    MON("Yeenoghu", "ÒÁÅµºú", S_DEMON, LVL(56, 18, -5, 80, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
    ...
    MON("Orcus", "°ÂåÈË¹", S_DEMON, LVL(66, 9, -6, 85, -20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        M3_WAITFORU | M3_WANTSBOOK | M3_WANTSAMUL | M3_INFRAVISIBLE
            | M3_INFRAVISION,
        36, HI_LORD),
    MON("Geryon", "¼ªÀï°º", S_DEMON, LVL(72, 3, -3, 75, 15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 3, 6),
    ...
    MON("Dispater", "µÏË¹ÅÁÌØ", S_DEMON, LVL(78, 15, -2, 80, 15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
    ...
    MON("Baalzebub", "°ÍÁ¦Î÷²·", S_DEMON, LVL(89, 9, -5, 85, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        45, HI_LORD),
    MON("Asmodeus", "°¢Ë¹ÄªµÂ", S_DEMON, LVL(105, 12, -7, 90, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        M3_WANTSAMUL | M3_WAITFORU | M3_INFRAVISIBLE | M3_INFRAVISION,
        53, HI_LORD),
    MON("Demogorgon", "µÒÄ¦¸ß¸ù", S_DEMON, LVL(106, 15, -8, 95, -20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
     ...
     */
    MON("Death", "ËÀÍö", S_DEMON, LVL(30, 12, -5, 100, 0), (G_UNIQ | G_NOGEN),
    ...
    MON("Pestilence", "ÎÁÒß", S_DEMON, LVL(30, 12, -5, 100, 0), (G_UNIQ | G_NOGEN),
        ...
        M2_NOPOLY | M2_STALK | M2_HOSTILE | M2_PNAME | M2_STRONG | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_DISPLACES, 34, HI_LORD),
    MON("Famine", "¼¢»Ä", S_DEMON, LVL(30, 12, -5, 100, 0), (G_UNIQ | G_NOGEN),
     ...
     */
#ifdef MAIL
    MON("mail daemon", "ÓÊ¼þÓÄÁé³ÌÐò", S_DEMON, LVL(56, 24, 10, 127, 0),
        (G_NOGEN | G_NOCORPSE),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        26, CLR_BRIGHT_BLUE),
#endif
    MON("djinni", "µÆÉñ", S_DEMON, LVL(7, 12, 4, 30, 0), (G_NOGEN | G_NOCORPSE),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
     ...
     * sea monsters
     */
    MON("jellyfish", "Ë®Ä¸", S_EEL, LVL(3, 3, 6, 0, 0), (G_GENO | G_NOGEN),
    ...
    MON("piranha", "Ë®»¢Óã", S_EEL, LVL(5, 12, 4, 0, 0), (G_GENO | G_NOGEN | G_SGROUP),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("shark", "öèÓã", S_EEL, LVL(7, 12, 2, 0, 0), (G_GENO | G_NOGEN),
    ...
    MON("giant eel", "¾ÞÐÍ÷©Óã", S_EEL, LVL(5, 9, -1, 0, 0), (G_GENO | G_NOGEN),
    ...
    MON("electric eel", "µç÷©", S_EEL, LVL(7, 10, -3, 0, 0), (G_GENO | G_NOGEN),
    ...
    MON("kraken", "º£Ñý", S_EEL, LVL(20, 3, 6, 0, -3), (G_GENO | G_NOGEN),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
    ...
    MON("crocodile", "öùÓã", S_LIZARD, LVL(6, 9, 5, 0, 0), (G_GENO | 1),
    ...
    MON("salamander", "»ðòáòæ", S_LIZARD, LVL(8, 12, -1, 0, -9), (G_HELL | 1),
     ...
     */
    MON("long worm tail", "³¤Èä³æÎ²", S_WORM_TAIL, LVL(0, 0, 0, 0, 0),
        (G_NOGEN | G_NOCORPSE | G_UNIQ),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
     ...
     * character classes
     */
    MON("archeologist", "¿¼¹ÅÑ§¼Ò", S_HUMAN, LVL(10, 12, 10, 1, 3), G_NOGEN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("barbarian", "Ò°ÂùÈË", S_HUMAN, LVL(10, 12, 10, 1, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("caveman", "Ñ¨¾ÓÈË", S_HUMAN, LVL(10, 12, 10, 0, 1), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("cavewoman", "Å®Ñ¨¾ÓÈË", S_HUMAN, LVL(10, 12, 10, 0, 1), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        ...
        M3_INFRAVISIBLE, 12, HI_DOMESTIC),
    MON("healer", "Ò½Éú", S_HUMAN, LVL(10, 12, 10, 1, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("knight", "ÆïÊ¿", S_HUMAN, LVL(10, 12, 10, 1, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("monk", "É®ÂÂ", S_HUMAN, LVL(10, 12, 10, 2, 0), G_NOGEN,
        ...
        M3_INFRAVISIBLE, 11, HI_DOMESTIC),
    MON("priest", "ÄÁÊ¦", S_HUMAN, LVL(10, 12, 10, 2, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_MALE | M2_COLLECT,
        M3_INFRAVISIBLE, 12, HI_DOMESTIC),
    MON("priestess", "Å®ÄÁÊ¦", S_HUMAN, LVL(10, 12, 10, 2, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_FEMALE | M2_COLLECT,
        M3_INFRAVISIBLE, 12, HI_DOMESTIC),
    MON("ranger", "ÓÎÏÀ", S_HUMAN, LVL(10, 12, 10, 2, -3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("rogue", "µÁÔô", S_HUMAN, LVL(10, 12, 10, 1, -3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        ...
        M3_INFRAVISIBLE, 12, HI_DOMESTIC),
    MON("samurai", "ÎäÊ¿", S_HUMAN, LVL(10, 12, 10, 1, 3), G_NOGEN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("tourist", "ÓÎ¿Í", S_HUMAN, LVL(10, 12, 10, 1, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("valkyrie", "Å®ÎäÉñ", S_HUMAN, LVL(10, 12, 10, 1, -1), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_FEMALE | M2_COLLECT,
        M3_INFRAVISIBLE, 12, HI_DOMESTIC),
    MON("wizard", "Î×Ê¦", S_HUMAN, LVL(10, 12, 10, 3, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
     ...
     * quest leaders
     */
    MON("Lord Carnarvon", "¿¨ÄÇ·âÑ«¾ô", S_HUMAN, LVL(20, 12, 0, 30, 20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("Pelias", "çêÀû°¢Ë¹", S_HUMAN, LVL(20, 12, 0, 30, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, 22, HI_LORD),
    MON("Shaman Karnov", "ÈøÂú¿¨Åµ·ò", S_HUMAN, LVL(20, 12, 0, 30, 20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("Elwing", S_HUMAN,
        ...
        M3_CLOSE | M3_INFRAVISION | M3_INFRAVISIBLE, 22, HI_LORD),
#endif
    MON("Hippocrates", "Ï£²¨¿ËÀ­µ×", S_HUMAN, LVL(20, 12, 0, 40, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, 22, HI_LORD),
    MON("King Arthur", "ÑÇÉªÍõ", S_HUMAN, LVL(20, 12, 0, 40, 20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("Grand Master", "×ÚÊ¦", S_HUMAN, LVL(25, 12, 0, 70, 0), (G_NOGEN | G_UNIQ),
    ...
    MON("Arch Priest", "´ó¼ÀË¾", S_HUMAN, LVL(25, 12, 7, 70, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_KICK, AD_PHYS, 2, 8),
          ATTK(AT_MAGC, AD_CLRC, 2, 8), ATTK(AT_MAGC, AD_CLRC, 2, 8), NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN),
    ...
    MON("Orion", "¶íÀïÎÌ", S_HUMAN, LVL(20, 12, 0, 30, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
     ...
     */
    MON("Master of Thieves", "µÁÔô´óÊ¦", S_HUMAN, LVL(20, 12, 0, 30, -20),
        (G_NOGEN | G_UNIQ),
    ...
    MON("Lord Sato", "ÈøÍÐÁìÖ÷", S_HUMAN, LVL(20, 12, 0, 30, 20), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, 23, HI_LORD),
    MON("Twoflower", "Ë«»¨", S_HUMAN, LVL(20, 12, 10, 20, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("Norn", "Åµ¶÷", S_HUMAN, LVL(20, 12, 0, 80, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_FEMALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, 23, HI_LORD),
    MON("Neferet the Green", "ÂÌÒÂÄÈ·ÆÀûÌØ", S_HUMAN, LVL(20, 12, 0, 60, 0),
        (G_NOGEN | G_UNIQ),
     ...
     * quest nemeses
     */
    MON("Minion of Huhetotl", "ÐÞµÌ¿âÌØÀïµÄÅ«²Å", S_DEMON, LVL(16, 12, -2, 75, -14),
        ...
        23, CLR_RED),
    MON("Thoth Amon", "Í¼ÌØ°¢ÃÉ", S_HUMAN, LVL(16, 12, 0, 10, -14),
     ...
     */
    MON("Chromatic Dragon", "²ÊÉ«Áú", S_DRAGON, LVL(16, 12, 0, 30, -14),
        (G_NOGEN | G_UNIQ),
    ...
    MON("Goblin King", S_ORC,
        ...
        18, HI_LORD),
#endif
    MON("Cyclops", "¶ÀÑÛ¾ÞÈË", S_GIANT, LVL(18, 12, 0, 0, -15), (G_NOGEN | G_UNIQ),
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISION | M3_INFRAVISIBLE,
        23, CLR_GRAY),
    MON("Ixoth", "¶ñÁú", S_DRAGON, LVL(15, 12, -1, 20, -14), (G_NOGEN | G_UNIQ),
    ...
    MON("Master Kaen", "¿­¶÷´óÊ¦", S_HUMAN, LVL(25, 12, -10, 10, -20), (G_NOGEN | G_UNIQ),
    ...
    MON("Nalzok", "ÄÉ×ÚÄ§", S_DEMON, LVL(16, 12, -2, 85, -127),
        (G_NOGEN | G_UNIQ | G_NOCORPSE),
        A(ATTK(AT_WEAP, AD_PHYS, 8, 4), ATTK(AT_WEAP, AD_PHYS, 4, 6),
          ATTK(AT_MAGC, AD_SPEL, 0, 0), ATTK(AT_CLAW, AD_SAMU, 2, 6), NO_ATTK,
          NO_ATTK),
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISION | M3_INFRAVISIBLE,
        23, CLR_RED),
    MON("Scorpius", "Ð«åó", S_SPIDER, LVL(15, 12, 10, 0, -15), (G_NOGEN | G_UNIQ),
    ...
    MON("Master Assassin", "´Ì¿Í´óÊ¦", S_HUMAN, LVL(15, 12, 0, 30, 18),
        (G_NOGEN | G_UNIQ),
     ...
     * of his time.
     */
    MON("Ashikaga Takauji", "×ãÀû×ðÊÏ", S_HUMAN, LVL(15, 12, 0, 40, -13),
        (G_NOGEN | G_UNIQ | G_NOCORPSE),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6),
          ATTK(AT_CLAW, AD_SAMU, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_NEMESIS, MZ_HUMAN), MR_STONE, 0,
     ...
     */
    MON("Lord Surtur", "Ðð¶ûÌØÁìÖ÷", S_GIANT, LVL(15, 12, 2, 50, 12), (G_NOGEN | G_UNIQ),
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISION | M3_INFRAVISIBLE,
        19, HI_LORD),
    MON("Dark One", "ºÚ°µÄ§¾ý", S_HUMAN, LVL(15, 12, 0, 80, -10),
        (G_NOGEN | G_UNIQ | G_NOCORPSE),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
     ...
     * quest "guardians"
     */
    MON("student", "Ñ§Õß", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("chieftain", "Çõ³¤", S_HUMAN, LVL(5, 12, 10, 10, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("neanderthal", "Äá°²µÂÌØÈË", S_HUMAN, LVL(5, 12, 10, 10, 1), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
...
#endif
    MON("attendant", "»¤ÀíÕß", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("page", "ÊµÏ°ÆïÊ¿", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("abbot", "·½ÕÉ", S_HUMAN, LVL(5, 12, 10, 20, 0), G_NOGEN,
    ...
    MON("acolyte", "ÊÌ¼À", S_HUMAN, LVL(5, 12, 10, 20, 0), G_NOGEN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 8, HI_DOMESTIC),
    MON("hunter", "ÁÔÈË", S_HUMAN, LVL(5, 12, 10, 10, -7), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_SEE_INVIS | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISION | M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("thug", "´Ì¿Í", S_HUMAN, LVL(5, 12, 10, 10, -3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_PEACEFUL
        ...
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("ninja", "ÈÌÕß", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("roshi", "ìøÊ¦", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("guide", "µ¼ÓÎ", S_HUMAN, LVL(5, 12, 10, 20, 0), G_NOGEN,
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_PEACEFUL
                                       | M2_STRONG | M2_COLLECT | M2_MAGIC,
        M3_INFRAVISIBLE, 8, HI_DOMESTIC),
    MON("warrior", "Õ½Ê¿", S_HUMAN, LVL(5, 12, 10, 10, -1), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_PEACEFUL
        ...
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("apprentice", "Ä§·¨Ñ§Í½", S_HUMAN, LVL(5, 12, 10, 30, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_MAGC, AD_SPEL, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_PEACEFUL
